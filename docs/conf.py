...
latex_documents = [
    ("index", "opaque_keys.tex", "opaque\\_keys Documentation", "Author", "manual"),
]
...
man_pages = [("index", "opaque_keys", "opaque_keys Documentation", ["Author"], 1)]
