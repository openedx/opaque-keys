...
class LocatorBaseTest(TestCase):
    ...
    def check_course_locn_fields(
        self, testobj, version_guid=None, org=None, course=None, run=None, branch=None
    ):
        """
    ...
    def check_block_locn_fields(
        ...
        """
        self.check_course_locn_fields(testobj, version_guid, org, course, run, branch)
